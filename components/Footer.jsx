...
const FooterLinks = ({ heading, items }) => (
  <div className="flex-1 justify-start items-start mt-2">
    <h3 className="font-popping dark:text-white text-nft-black-1 font-semibold text-xl mb-8">
      {heading}
    </h3>
...
const Footer = () => {
  ...
  return (
    <footer className="flexCenter flex-col border-t dark:border-nft-black-1 boder-nft-gray-1 sm:py-8 py-16">
      <div className="w-full minmd:w-4/5 flex flex-row sm:px-4 px-16">
      ...
      <div className="flexCenter w-full mt-5 border-t dark:border-nft-black-1 border-nft-gray-1 sm:px-4 px-16">
        <div className="flexBetween flex-row w-full minmd:w-4/5 sm:flex-col mt-7">
          <p className="font-poppins dark:text-white text-nft-black-1 font-semibold text-base">
            Cryptocart, Inc. All right Reserved.
          </p>
