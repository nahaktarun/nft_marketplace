    ...
    <div className="relative flex justify-center md:flex-col min-h-screen">
      ...
      <div className="flex-1 justify-start sm:px-4 p-12 sm:pb-4">
        ...
        <div className="mt-10 flex flex-col">
          <div className="w-full border-b dark:border-nft-black 1 border-nft-gray-1 flex felx-row">
            <p className="font-popping dark:text-white text-nft-black-1 text-base  minlg:text-base font-medium mb-2">
              Details
            </p>
          </div>
          <div className="mt-3">
            <p className="font-popping dark:text-white text-nft-black-1 text-base  font-normal ">
              {" "}
              {nft.description}
            </p>
          </div>
        ...
        <div className="flex flex-row sm:flex-col mt-10">
          {currentAccount === nft.seller.toLowerCase() ? (
            <p className="font-popping dark:text-white text-nft-black-1 text-base  font-normal border border-gray p-2 ">
